...
SMS_WRITE_32(SMS_PORT_REGION(0x8016DEA8, 0, 0, 0), 0x5464043E);
SMS_WRITE_32(SMS_PORT_REGION(0x8016DF1C, 0, 0, 0), 0x5464043E);
SMS_WRITE_32(SMS_PORT_REGION(0x8016E204, 0, 0, 0), 0x5464043E);
SMS_WRITE_32(SMS_PORT_REGION(0x8016F6DC, 0, 0, 0), 0x5464043E);
SMS_WRITE_32(SMS_PORT_REGION(0x80174E50, 0, 0, 0), 0x5464043E);
SMS_WRITE_32(SMS_PORT_REGION(0x8017BE78, 0x80171EA8, 0, 0), 0x5464043E);
SMS_WRITE_32(SMS_PORT_REGION(0x8017BEF4, 0x80171F24, 0, 0), 0x5464043E);
SMS_WRITE_32(SMS_PORT_REGION(0x8017BF34, 0x80171F6C, 0, 0), 0x5464043E);
SMS_WRITE_32(SMS_PORT_REGION(0x8017BFB4, 0x80171F6C, 0, 0), 0x5464043E);
...
SMS_WRITE_32(SMS_PORT_REGION(0x801BCE30, 0x801B4CE8, 0, 0), 0x5404043E);
SMS_WRITE_32(SMS_PORT_REGION(0x801FF850, 0x801F7734, 0, 0), 0x5404043E);
